...
import { Clock, Monitor, User, Shield, AlertTriangle, X } from "lucide-react";
          ...
          {filteredAlerts.map((alert, index) => {
            ...
            return (
              <div key={alert.id} className="relative pl-16">
                ...
                {/* Event card */}
                <div className="bg-blue-950/30 rounded-lg p-4 border border-blue-500/10 hover:bg-blue-950/40 transition-all">
