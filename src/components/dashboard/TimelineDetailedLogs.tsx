      ...
      <div className="flex-1 overflow-hidden">
        <div className="w-full h-full border border-[#7B68EE]/20 rounded-md bg-[#1E1E2F]">
          {totalRecords !== undefined && (
            <div className="p-4 text-sm text-gray-400 border-b border-[#7B68EE]/20">
              Total Records: {totalRecords}
            </div>
          )}
          <div className="overflow-x-auto mt-6"> {/* Added mt-6 for top spacing */}
            <Table>
              ...
              <TableBody className="space-y-2"> {/* Added space-y-2 for row spacing */}
                {logs.map((log) => (
                  <TimelineLogCard
                    key={log.id}
                    log={log}
      ...
      {selectedLog && (
        <div className="w-[600px] border-l border-[#7B68EE]/20 pl-4 overflow-y-auto max-h-screen">
          <div className="space-y-6">
            <div className="flex justify-between items-center mb-6"> {/* Added mb-6 for bottom margin */}
            ...
            <div className="space-y-8"> {/* Increased space-y-6 to space-y-8 for more spacing */}
              <div>
