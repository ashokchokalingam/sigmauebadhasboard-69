  ...
  const categories = [
    {
      ...
      secondaryMetric: `${((safeStats.critical / (totalAlerts || 1)) * 100).toFixed(1)}% of total`,
      ringColor: "ring-red-500/20",
      textGradient: "from-red-500 via-red-400 to-red-300"
    },
    {
      title: "High Risk Events",
      count: safeStats.high,
      ...
      secondaryMetric: `${((safeStats.high / (totalAlerts || 1)) * 100).toFixed(1)}% of total`,
      ringColor: "ring-orange-500/20",
      textGradient: "from-orange-500 via-orange-400 to-orange-300"
    },
    {
      title: "Systems Affected",
      count: safeStats.systems,
