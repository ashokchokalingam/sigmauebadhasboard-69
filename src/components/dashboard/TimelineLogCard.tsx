...
const TimelineLogCard = ({ log, isExpanded, onToggleExpand }: TimelineLogCardProps) => {
  ...
  return (
    <>
      ...
      {isExpanded && (
        <TableRow className="bg-[#1E1E2F]/50">
          <TableCell colSpan={6} className="p-4">
            <div className="space-y-4">
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-400">Raw Data</h3>
                <pre className="text-xs text-gray-300 bg-[#1A1F2C] p-4 rounded-md overflow-x-auto">
