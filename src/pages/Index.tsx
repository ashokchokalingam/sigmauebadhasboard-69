...
const data = [
  { name: "Initial Access", alerts: 24 },
  { name: "Execution", alerts: 13 },
  { name: "Persistence", alerts: 18 },
  { name: "Privilege Escalation", alerts: 8 },
  { name: "Defense Evasion", alerts: 15 },
];

const Index = () => {
  return (
    <div className="min-h-screen bg-background p-6">
      <h1 className="text-3xl font-bold mb-6">UEBA Security Dashboard</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Mitigations Active</CardTitle>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className="col-span-2">
          <CardHeader>
            <CardTitle>MITRE ATT&CK Tactics Alerts</CardTitle>
          </CardHeader>
          <CardContent>
